 ...
 * Summary: Native installer logic for the chulengo runtime on Windows.
 *
 * Author:  KaisarCode
...
static const struct kc_file_entry KC_FILES[] = {
    { KC_REPO_ROOT "/bin/win64/chulengo.exe", "bin\\chulengo.exe" },
...
/**
 * Updates PATH entries used by chulengo.
 * @param config Active config.
 * @return 0 on success, otherwise 1.
 */
